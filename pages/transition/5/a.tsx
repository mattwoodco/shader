...
export default function SimpleLogin_A() {
  return (
    <div className="flex flex-col overflow-hidden py-12 relative z-0 h-full w-full gap-10">
      ...
      <div className="relative z-10 px-10 flex flex-col h-full justify-end">
        <Link href="/transition/5/b">
          <motion.div layoutId="list" layout className="flex flex-col h-40">
            <motion.div
              layout
              layoutId="list1"
